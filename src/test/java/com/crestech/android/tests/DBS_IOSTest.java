...
public class DBS_IOSTest extends UserBaseTest {
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 3, enabled = true, description = "Logout-ONEAPP-9392", dependsOnMethods = { "PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 4, enabled = true, description = "Remittance-Corridor-ONEAPP-13407", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 5, enabled = true, description = "Remittance-eOTT-ONEAPP-14008", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 6, enabled = true, description = "Payee-Add-DBSorPOSB-ONEAPP-14675", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 7, enabled = true, description = "TopUp-PayLah-ONEAPP-13915", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 8, enabled = true, description = "Payee-Add-Remittance-ONEAPP-13679", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 9, enabled = true, description = "ApplyDebitCard-ONEAPP-15861", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 10, enabled = true, description = "Payee-Add-Local-OtherBank-ONEAPP-15677", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 11, enabled = true, description = "Payee-Add-BillPayment-ONEAPP-15938", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 12, enabled = true, description = "OpenAccount-ONEAPP-14028", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 13, enabled = true, description = " ChangeLocalFundsTransferLimit-Increase-ONEAPP-7847", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 18, enabled = true, description = "FundsTransfer-OwnAccount-ONEAPP-16730", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 19, enabled = true, description = "FundsTransfer-OtherPOSBDBS-ONEAPP-16723", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 20, enabled = true, description = "TransactionHistory-ONEAPP-14312", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 21, enabled = true, description = "Verifies Credit Card Temperory Limit Increase", dependsOnMethods = {
			"PreRequisiteScript" })
	...
	@Parameters({ "userName", "password", "app_Name" })
	@Test(priority = 22, enabled = true, description = "UpdatePersonalParticular-ONEAPP-13921", dependsOnMethods = {
			"PreRequisiteScript" })
